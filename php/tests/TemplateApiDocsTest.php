 ...
 */
final class TemplateApiDocsTest extends TestCase
{
    ...
    private static function mountedRoutes(): array
    {
        ...
        // `register()` needs one — see the PSR-11 stub in TemplateModuleTest.
        $app = AppFactory::create();
        $registry = new ModuleRegistry([new TemplateModule()]);
    ...
    public function testEveryEntryIsWellFormed(): void
    {
        $permissions = array_map(
            ...
            (new TemplateModule())->permissions(),
        );

        foreach ((new TemplateModule())->apiDocs() as $doc) {
